...
// Choice
var IfStatement = DefineNode({
    type: "IfStatement",
    test: "Expression",
    consequent: "Statement",
    alternate: ["Statement", "null"]
}, Statement);
var _IfStatement = DefineNode({
    type: "IfStatement",
    test: undefined,
...
var SwitchStatement = DefineNode({
...
var TryStatement = DefineNode({
    type: "TryStatement",
    block: "BlockStatement",
    handler: ["CatchClause", "null"],
    finalizer: ["BlockStatement", "null"]
}, Statement);
var _TryStatement = DefineNode({
    type: "TryStatement",
    block: undefined,
    handler: undefined,
    finalizer: undefined
...
var _FunctionDeclaration = DefineNode({
...
var VariableDeclaration = DefineNode({
...
var _VariableDeclarator = DefineNode({
...
var ForInStatement = DefineNode({
    type: "ForInStatement",
    left: ["VariableDeclaration", "Pattern"],
    right: "Expression",
    body: "Statement"
}, Statement);
var _ForInStatement = DefineNode({
    type: "ForInStatement",
    left: undefined,
    right: undefined,
    body: undefined
...
var _FunctionExpression = DefineNode({
...
var UnaryExpression = DefineNode({
    type: "UnaryExpression",
    operator: "UnaryOperator",
    prefix: "Boolean",
    argument: "Expression"
}, Expression);
var _UnaryExpression = DefineNode({
    type: "UnaryExpression",
    operator: undefined,
    prefix: undefined,
    argument: undefined
...
var UpdateExpression = DefineNode({
    type: "UpdateExpression",
    operator: "UpdateOperator",
    argument: "Expression",
    prefix: "Boolean"
}, Expression);
var _UpdateExpression = DefineNode({
    type: "UpdateExpression",
    operator: undefined,
    argument: undefined,
    prefix: undefined
...
var BinaryExpression = DefineNode({
    type: "BinaryExpression",
    operator: "BinaryOperator",
    left: "Expression",
    right: "Expression"
}, Expression);
var _BinaryExpression = DefineNode({
    type: "BinaryExpression",
    operator: undefined,
    left: undefined,
    right: undefined
...
var AssignmentExpression = DefineNode({
    type: "AssignmentExpression",
    operator: "AssignmentOperator",
    left: ["Pattern", "Expression"],
    right: "Expression"
}, Expression);
var _AssignmentExpression = DefineNode({
    type: "AssignmentExpression",
    operator: undefined,
    left: undefined,
    right: undefined
...
var LogicalExpression = DefineNode({
    type: "LogicalExpression",
    operator: "LogicalOperator",
    left: "Expression",
    right: "Expression"
}, Expression);
var _LogicalExpression = DefineNode({
    type: "LogicalExpression",
    operator: undefined,
    left: undefined,
    right: undefined
...
var MemberExpression = DefineNode({
    type: "MemberExpression",
    object: "Expression",
    property: ["Expression", "Identifier"],
    computed: "Boolean"
}, Expression, Pattern);
var _MemberExpression = DefineNode({
    type: "MemberExpression",
    object: undefined,
    property: undefined,
    computed: true
...
LogicalExpression
var ConditionalExpression = DefineNode({
    type: "ConditionalExpression",
    test: "Expression",
    alternate: "Expression",
    consequent: "Expression"
}, Expression);
var _ConditionalExpression = DefineNode({
    type: "ConditionalExpression",
    test: undefined,
    alternate: undefined,
    consequent: undefined
...
var _ForOfStatement = DefineNode({
    type: "ForOfStatement",
    left: undefined,
    right: undefined,
    body: undefined
...
var ArrowFunctionExpression = DefineNode({
    type: "ArrowFunctionExpression",
    body: ["FunctionBody", "Expression"],
    expression: "Boolean"
}, Function, Expression);
var _ArrowFunctionExpression = DefineNode({
    type: "ArrowFunctionExpression",
    expression: false,
    generator: false,
    async: false,
...
var YieldExpression = DefineNode({
...
// Template Literals
var TemplateElement = DefineNode({
    type: "TemplateElement",
    tail: "Boolean",
    value: {cooked: "String", raw: "String"}
}, Node);
var _TemplateElement = DefineNode({
    type: "TemplateElement",
    tail: undefined,
    value: {cooked: undefined, raw: undefined}
}, Node);
var TemplateLiteral = DefineNode({
    type: "TemplateLiteral",
    quasis: [["TemplateElement"]],
    expressions: [["Expression"]]
}, Expression);
var _TemplateLiteral = DefineNode({type: "TemplateLiteral", quasis: [], expressions: []}, Expression);
var TaggedTemplateExpression = DefineNode({
    type: "TaggedTemplateExpression",
    tag: "Expression",
    quasi: "TemplateLiteral"
}, Expression);
var _TaggedTemplateExpression = DefineNode({
    type: "TaggedTemplateExpression",
    tag: undefined,
    quasi: undefined
}, Expression);
...
// Patterns
var AssignmentProperty = DefineNode({
    type: "AssignmentProperty",
    value: "Pattern",
    kind: "init",
    method: "false"
}, Property);
var _AssignmentProperty = DefineNode({
    type: "AssignmentProperty",
    key: undefined,
    value: undefined,
    kind: undefined,
...
var MethodDefinition = DefineNode({
...
var _MethodDefinition = DefineNode({
    type: "MethodDefinition",
    key: undefined,
    value: undefined,
    kind: undefined,
